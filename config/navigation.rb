...
SimpleNavigation::Configuration.run do |navigation|
  ...
  navigation.items do |primary|
    primary.item :comics, 'Comics', root_path do |comic|
      comic.item :offensive, 'Offensively Offensive', offensive_path
      comic.item :random, 'Random', random_path
      comic.item :mayuyu, 'Mayuyu\'s Anger Diaries', mayuyu_path
      comic.item :tina, 'Tina And Her Funny Friends', tina_path
    end
    primary.item :archive, 'Archive', archive_path
    primary.item :about, 'About', about_path
 #   if user_signed_in?
 #     primary.item :username, current_user.name # user site?
 #   else
